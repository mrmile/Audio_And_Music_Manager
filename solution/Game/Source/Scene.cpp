...
bool Scene::Update(float dt)
{
	...
	{
		//Todo 4.1 (done): Use the new playFX function to play glassBreak sound effect spatially
	...
	{
		//Todo 4.2 (done): Use the new playFX function to play steamValve sound effect spatially
		//(the speakers center coordinates are { 640, 360 })
	...
	{
		//Todo 4.3 (done): Use the new playFX function to play activationSound sound effect spatially
		//(the speakers center coordinates are { 640, 360 })
	...
	{
		//Todo 4.4 (done): Use the new playFX function to play the modular "ventWalk" sound effect
		//(the speakers center coordinates are { 640, 360 })
	...
	{
		// Todo 5.1 (done): Use the ChangeMusic function to switch the music to OFF (feel free to experiment with fades)
		app->audio->ChangeMusic(OFF, 0.0f, 0.0f);
	}

	if (app->input->GetKey(SDL_SCANCODE_F6) == KEY_DOWN)
	{
		// Todo 5.2 (done): Use the ChangeMusic function to switch the music to EL_BOOM (feel free to experiment with fades)
		app->audio->ChangeMusic(EL_BOOM, 1.0f, 1.0f);
	}

	if (app->input->GetKey(SDL_SCANCODE_F7) == KEY_DOWN)
	{
		// Todo 5.3 (done): Use the ChangeMusic function to switch the music to PRENDE_UN_PORRO (feel free to experiment with fades)
	...
	{
		// Todo 6 (done): Use the PlayMusicSpatially function to play music spatially when switched on
		//(the speakers center coordinates are { 640, 360 })
